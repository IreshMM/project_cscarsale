<div id="tabs2-1">
    <div class="product-list-classic">
        ...
        <div class="product-box-horizontal">
            ...
            <figure><a href="details?id={{ $item->id_car_listing }}"><img src="images/listing-{{ $i++ }}-322x230.jpg" alt="" class="img-responsive"></a></figure>
                <div class="caption">
                    <div class="caption-header">
                        <div class="info1">
                            <div class="txt1"><a href="details.html">{{ $item->model()->first()->name . ' | ' . $item->color . ' | ' . $item->city }}</a></div>
                    ...
                    <div class="caption-footer">
                        ...
                        <div class="txt7"><a href="details?id={{ $item->id_car_listing }}" class="btn-default btn3">VIEW DETAILS</a></div>
                    </div>
                </div>
            </div>
        </div>
