                    ...
                    <div class="rd-navbar-main-element">
                        <div class="rd-navbar-nav-wrap">
                            ...
                            <ul class="rd-navbar-nav">
                                <li class="rd-nav-item active"><a class="rd-nav-link" href="#home" data-custom-scroll-to="home">Home</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" data-custom-scroll-to="welcome" href="#welcome">About</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="#best" data-custom-scroll-to="best" >Best offers</a></li>
