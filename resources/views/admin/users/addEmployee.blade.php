...
@endsection
@section('content')
{{-- Add employee blade action to employee.create --}}
<div class="card">
            ...
            <div>
                <h3>Profile</h3>
                    <section>
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="datepicker" name ="dob" placeholder="mm/dd/yyyy">
                ...
                <h3>Position</h3>
                    ...
                    <section>
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control"  id="datepicker" name ="hire_date" placeholder="mm/dd/yyyy">
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
